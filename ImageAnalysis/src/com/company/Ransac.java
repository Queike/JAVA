...
public class Ransac {
    ...
    public Matrix ransacAlgorithm(boolean affine) {
        ...
        for (int currentIterationNumber = 0; currentIterationNumber < numberOfIterations; currentIterationNumber++) {
            Matrix model = null;
    ...
    private Matrix calculateModelAffine(ArrayList<Pair> samples) {
        ...
        double[][] matrixArray = {
                {samples.get(0).getKeyPointA().getCoordinateX(), samples.get(0).getKeyPointA().getCoordinateY(), 1, 0, 0, 0},
